...
public class FollowActingCharacter : MonoBehaviour {
	...
	void LateUpdate () // LateUpdate is called after Update and FixedUpdate have been called. Good for tracking stuff.
    {
        ...
        newPos = new Vector3(actingCharacterTransform.position.x, actingCharacterTransform.position.y, -20f); // Getting the x,y coordinates of the current acting character and a z value of -20 and storing it into newPos. 
